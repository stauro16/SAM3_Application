...
# -------------------------------------------------------------------------
# 17. POLE MASK OVERLAP FILTER NEW_1
# -------------------------------------------------------------------------
...
#     # NEW: overlap band (must touch pole, but not be mostly pole)
#     MIN_POLE_TOUCH = 0.02          # existing “must touch pole”
#     MAX_POLE_OVERLAP = 0.30        # new “too much pole = reject”
...
#         # NEW: keep only if overlap is within [MIN_POLE_TOUCH, MAX_POLE_OVERLAP]
#         keep_flags.append(bool((frac >= MIN_POLE_TOUCH) and (frac <= MAX_POLE_OVERLAP)))
...
#             "pole_overlap_outside_"
#             + f"[{MIN_POLE_TOUCH:.3f},{MAX_POLE_OVERLAP:.3f}]"
#         )
# else:
#     final_kept_detections_df = kept_after_cluster_df.copy()
