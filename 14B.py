...
def _build_overlay_output_path(row, image_id):
    ...
    if relative_dir in ("", "."):
        ...
        target_dir = os.path.join(SILVER_POLE_SELECTION_OVERLAYS, relative_dir)
...
# -----------------------------------------------------------------------------
# 2. Production run across all images
# -----------------------------------------------------------------------------
candidate_frames = []
selection_rows = []
pole_mask_lookup = {}
...
if "save_state" in globals():
    save_state(
        ...
        config_extra={
            ...
            "W_CONF": W_CONF,
            "W_EDGE": W_EDGE,
            "POLE_SELECTED_MASK_RGB": POLE_SELECTED_MASK_RGB,
            "POLE_SELECTED_MASK_ALPHA": POLE_SELECTED_MASK_ALPHA,
            "POLE_SELECTED_BOX_COLOR": POLE_SELECTED_BOX_COLOR,
            "POLE_SELECTED_BOX_LINEWIDTH": POLE_SELECTED_BOX_LINEWIDTH,
            "POLE_SELECTED_TEXT_COLOR": POLE_SELECTED_TEXT_COLOR,
            "POLE_SELECTED_LABEL_FONTSIZE": POLE_SELECTED_LABEL_FONTSIZE,
            "POLE_SELECTED_LABEL_BG_ALPHA": POLE_SELECTED_LABEL_BG_ALPHA,
            "POLE_SELECTED_LABEL_BBOX_PAD": POLE_SELECTED_LABEL_BBOX_PAD,
            "POLE_SELECTED_LABEL_Y_OFFSET": POLE_SELECTED_LABEL_Y_OFFSET,
            "NO_RELIABLE_POLE_LABEL_TEXT": NO_RELIABLE_POLE_LABEL_TEXT,
            "SILVER_POLE_SELECTION_OVERLAYS": SILVER_POLE_SELECTION_OVERLAYS,
        },
        nb_globals=globals(),
    )
else:
